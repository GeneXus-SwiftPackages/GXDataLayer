...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-4.2.0-beta.27.xcframework.zip",
			checksum: "47cdc1f4483414aacb16188db468adc4ecf6dc92ab2b10a5e7ebc3f9ca071ca9"
		)
	]
)