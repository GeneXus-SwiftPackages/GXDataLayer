...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-2.1.0-beta.26.xcframework.zip",
			checksum: "969177221b31f899060107df41af6c21a2f43f6915ccb6502a7a17b298c63418"
		)
	]
)