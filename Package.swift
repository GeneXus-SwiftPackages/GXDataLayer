...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-2.0.0-beta.36.xcframework.zip",
			checksum: "e6e392f22a98e7aa39c3c04c3cf439a600c053e04351fb91cfbdaf660235f6ac"
		)
	]
)