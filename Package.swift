...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-3.1.0-beta.31.xcframework.zip",
			checksum: "2e6cd8fee316f78ae04c533be6c0072cedba658a695786688070332306f99fc1"
		)
	]
)