...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-2.0.0-beta.31.xcframework.zip",
			checksum: "e0107cc509242caac2b205a49071003679860d07bf8cae7fff11f805c6fc23f7"
		)
	]
)