...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.2.0-beta.31.xcframework.zip",
			checksum: "3b48f7296f0bf3f7da9d75811714fb99e16a3bdb14bf6dc194ddcb49f9789776"
		)
	]
)