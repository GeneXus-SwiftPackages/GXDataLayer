...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-3.2.0-rc.11.xcframework.zip",
			checksum: "ef317902cd33829726d598e3811aa1d9aeca8930913e3a25d6bd652166176692"
		)
	]
)