...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-2.0.0-rc.34.xcframework.zip",
			checksum: "08a13ebf7a874922a5ac80433d17e4055677bc2153cb722b2fcf81b3faf1efb7"
		)
	]
)