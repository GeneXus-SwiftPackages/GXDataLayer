...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-2.1.0-rc.23.xcframework.zip",
			checksum: "d869f292eb514e6ca85316eb47b823e4b5e7800d795b513ca3e1b35e51fa89d5"
		)
	]
)