...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-3.2.0-beta.19.xcframework.zip",
			checksum: "c920bcfdba82aa8479ed8bf6753c9e04ea13103e2d045d7df865aa1dddbdae65"
		)
	]
)