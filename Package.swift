...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-2.0.0-rc.32.xcframework.zip",
			checksum: "1279dc7308c37d37e1d2ad8b5a265adce886608453190a9b0bce59204246df54"
		)
	]
)