...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.0.0-beta+20230525122919.xcframework.zip",
			checksum: "79fa53a58ab7fce20eee570830a4520f9d181ee951ba3ddb3774e5f6ba04b4a9"
		)
	]
)