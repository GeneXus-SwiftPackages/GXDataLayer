...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-2.0.0-beta.37.xcframework.zip",
			checksum: "5a01b2e662fecb60cdc2e0e8a2fd90b7a3d6841f64773801ac0e3553ecea6ee0"
		)
	]
)