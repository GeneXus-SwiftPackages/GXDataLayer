...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.0.0-beta+20230307184249.xcframework.zip",
			checksum: "8abe581834a114ccb9917b6bbd53b110f33747c281f55a6cb35334c0613c4ff5"
		)
	]
)