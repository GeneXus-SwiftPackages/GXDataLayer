...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.2.0-beta.21.xcframework.zip",
			checksum: "c121c031ef3e1aa6d29647fb9ae14731e7ec6ad179df45b87c4d5090e8ec0ce3"
		)
	]
)