...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-1.4.0-rc.10.xcframework.zip",
			checksum: "ff79143fe713809c952e3d885837699ba937b30c1a318b7f2b909a401bb274a5"
		)
	]
)