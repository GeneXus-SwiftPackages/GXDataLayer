...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.0.0-beta+20230330152753.xcframework.zip",
			checksum: "d8d1c4058f20b6be2a6f3500e8404a54309af4a59126ceef9c2f96df79f9df7b"
		)
	]
)