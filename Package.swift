...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.5.0-beta.11.xcframework.zip",
			checksum: "a48326f2e492e5e18691e1a2e296e31805a3042106165a7356cac8d27a363e4b"
		)
	]
)