...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-4.1.0-beta.23.xcframework.zip",
			checksum: "ddeca9279a58f6fd1892cea9f8cf7209dfc737299aca9c9a51e074466562e3b7"
		)
	]
)