...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-4.2.0-beta.26.xcframework.zip",
			checksum: "2be497a03dc248fac9b8f43caaff65819901fac0414912ad097602afbb9065bc"
		)
	]
)