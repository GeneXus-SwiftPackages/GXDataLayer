...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-3.2.0-beta.36.xcframework.zip",
			checksum: "984d52b86687e9f1e57fef92fe5a518442171132c92c2cc53d59ddecc208888d"
		)
	]
)