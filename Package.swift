...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-1.3.0-rc.13.xcframework.zip",
			checksum: "3ea674821677d163173f67386ba0681a36ea76dc230c80a2075b9eb121c18b08"
		)
	]
)