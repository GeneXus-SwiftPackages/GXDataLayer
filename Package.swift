...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.4.0-beta.11.xcframework.zip",
			checksum: "0e0fa660ffc9cf2d3dcc9f88dbcb82eae29ea66fb27207e891c8eb4df11a6f91"
		)
	]
)