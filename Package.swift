...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-1.2.0-rc.29.xcframework.zip",
			checksum: "613f473fc4ab5a91b1263f9380b98ee627bdf656d5fa18359b6abda7c3c4e5c7"
		)
	]
)