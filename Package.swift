...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.3.0-beta.11.xcframework.zip",
			checksum: "ab38320a32a7349b4f2ac01de18c4808eb234bc12fccfa34d4c585eae52b3136"
		)
	]
)