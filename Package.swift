...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-1.2.0-rc.36.xcframework.zip",
			checksum: "c9487d61408c3fb741f0a7512803de5e5dfa7d96e26cfd6e4fa9ba6defba7089"
		)
	]
)