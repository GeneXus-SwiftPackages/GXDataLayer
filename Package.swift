...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-2.2.0-beta.26.xcframework.zip",
			checksum: "aef806b9f5e605f3929ede74d23671696c9e19e9e0c8a40ccf040748f1e1643b"
		)
	]
)