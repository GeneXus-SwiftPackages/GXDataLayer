...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-3.2.0-beta.27.xcframework.zip",
			checksum: "472170cfe460e510230a751a14bf80ef6a40965a57b890e669b32fde85ef6b2b"
		)
	]
)