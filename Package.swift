...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.2.0-beta.24.xcframework.zip",
			checksum: "7a30a8f95baed74714d59d46088bd1ad64bcc136b7475a61aaa445860668fb78"
		)
	]
)