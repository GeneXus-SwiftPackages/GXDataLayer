...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.0.0-beta+20230519182256.xcframework.zip",
			checksum: "b1ccc254d39b1f8255e74be5464337d7e523dc29fc862a9a3a8bbc4e823a78ee"
		)
	]
)