...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-2.0.0-rc.22.xcframework.zip",
			checksum: "80d4ec45757a101518042b0c96e67183f2159a718255fbbcd6b808369d606e54"
		)
	]
)