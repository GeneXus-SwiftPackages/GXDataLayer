...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-1.2.0-rc.15.xcframework.zip",
			checksum: "69639e9d03e0bcf3c8ef33b64bf6903667704648e382908a622f0df6d64bad95"
		)
	]
)