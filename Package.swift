...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.0.0-beta+20230323104412.xcframework.zip",
			checksum: "24314db035c5f42e289449b0478cdd609abc691cdd6f0de28bb0a1bd285af160"
		)
	]
)