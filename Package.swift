...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.2.0-beta.17.xcframework.zip",
			checksum: "488a3f7e4256e546f489961f8178777188ae61d5980544f726ef87aeea33ec78"
		)
	]
)