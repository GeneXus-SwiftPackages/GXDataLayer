...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.2.0-beta.27.xcframework.zip",
			checksum: "f0dc18dca57716034c008597b2ac4582f69585cf587b9de799270ba64fc6ba1f"
		)
	]
)