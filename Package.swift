...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-3.1.0-beta.27.xcframework.zip",
			checksum: "bbc32cacd5aa824bca92c479f4ce7d24c73fb7eec03e245ad5bf4600df01dedd"
		)
	]
)