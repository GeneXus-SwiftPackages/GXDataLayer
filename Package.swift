...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-1.3.0-rc.7.xcframework.zip",
			checksum: "bca198380ab5940662ea0aa7458b0f16659e3b9302761431373dfc9514f7c244"
		)
	]
)