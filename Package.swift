...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-2.0.0-beta.40.xcframework.zip",
			checksum: "82e1b694af022f8abf4eb9bfa277b39d00b6502c1ac7f4afd78f5b7b93228ed9"
		)
	]
)