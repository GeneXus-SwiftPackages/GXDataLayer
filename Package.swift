...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.5.0-beta.24.xcframework.zip",
			checksum: "8a17fe18c4054275060cadea954b2299607c6f886c1e133ee8e4224444ac0168"
		)
	]
)