...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-2.0.0-beta.29.xcframework.zip",
			checksum: "ebf7e1066630e59e4b79b5778bf805b2fe7bc80fa708176f95015bd36bcdcad3"
		)
	]
)