...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-3.0.0-beta.15.xcframework.zip",
			checksum: "5826ef7633dc15d06c489b8c0da95283a92cd73672ddd60838c211165a4e2506"
		)
	]
)