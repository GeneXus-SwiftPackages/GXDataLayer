...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-2.2.0-rc.1.xcframework.zip",
			checksum: "9c42c17bc13110f9a0603eb42979c304042c9231d9ecbbe47f819e9989edddcb"
		)
	]
)