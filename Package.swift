...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-1.3.0-rc.1.xcframework.zip",
			checksum: "9156927d0ffdf21a8d3ee43fc2c022bb867b6cb3b82fb5566b1bdcf4fe02ff6c"
		)
	]
)