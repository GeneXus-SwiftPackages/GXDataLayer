...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-2.1.0-beta.24.xcframework.zip",
			checksum: "21df33d9b83795cfe6dfefaa75231879b429954b87f94d997f98bb2ad635f03b"
		)
	]
)