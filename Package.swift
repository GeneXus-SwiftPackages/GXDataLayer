...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.5.0-beta.21.xcframework.zip",
			checksum: "7389c82982bc00d002981da09efd62904021b1ef566a412b13d30974e3d1e550"
		)
	]
)