...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.0.0-beta+20230509131236.xcframework.zip",
			checksum: "649f5320ac9fbf942f147487bcd5cf3a129faa9113709e9a5942a3d4bfc02c75"
		)
	]
)