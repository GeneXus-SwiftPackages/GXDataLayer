...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.5.0-beta.19.xcframework.zip",
			checksum: "6d0af373f475b6c8577eab5dcb8314f3cd4ba10ca16a8e129226bb046d905100"
		)
	]
)