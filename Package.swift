...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.0.0-beta+20230531050040.xcframework.zip",
			checksum: "8855c42d9e5be4d55febd006be830a1f2daf91f3f1816902d4f9322866819b7f"
		)
	]
)