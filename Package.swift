...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-4.2.0-rc.34.xcframework.zip",
			checksum: "790ae3af6427c5247b859cb4d9b519597b984e053c321f488e9b28bfac26b22e"
		)
	]
)