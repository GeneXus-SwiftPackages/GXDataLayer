...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-1.6.0-rc.0.xcframework.zip",
			checksum: "1d36de93102df912d4a625109201b8137828515be1d76384ceb4391e7459d470"
		)
	]
)