...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.0.0-beta+20230315133647.xcframework.zip",
			checksum: "0aa0670766c3bddc07724cd25e691051a188928cb4af7f29a2a252d14c999605"
		)
	]
)