...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-2.1.0-beta.25.xcframework.zip",
			checksum: "98a571de98c288cc1b906ee71258ccaf9f4818b50e664a874947925e454255d3"
		)
	]
)