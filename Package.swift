...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-1.4.0-rc.5.xcframework.zip",
			checksum: "1d30426b1514e80c04263e5c1437492398a3c2c07919a8b4b36f219c0027b8d1"
		)
	]
)