...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.5.0-beta.18.xcframework.zip",
			checksum: "fac337aae68de36d0a1c7badcc3a98f3e32041f08120d2e819771584431e5064"
		)
	]
)