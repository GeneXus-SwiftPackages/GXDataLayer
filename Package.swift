...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDataLayer-1.2.0-beta.28.xcframework.zip",
			checksum: "dc0a0df6d95343545d51d73ea7c3d2ebd00521d01c426bcf6e6c05e8d3291e9b"
		)
	]
)