...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDataLayer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDataLayer-1.5.0-rc.28.xcframework.zip",
			checksum: "d717b9c78756672a227377b2b6775972a0149bb426b06c62e9499aeffaf5b4a1"
		)
	]
)